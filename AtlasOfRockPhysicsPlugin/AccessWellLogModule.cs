...
namespace AtlasOfRockPhysicsPlugin
{
    ...
    {
        private Process m_sc9_copywelllogusingspecifiedmarkersInstance;
        private Process m_sc8_copywellloginaspecifiedzoneInstance;
        ...
        {
            // Register AtlasOfRockPhysicsPlugin.ZonationWorksteps.Sc9_CopyWellLogUsingSpecifiedMarkers
            AtlasOfRockPhysicsPlugin.ZonationWorksteps.Sc9_CopyWellLogUsingSpecifiedMarkers sc9_copywelllogusingspecifiedmarkersInstance = new AtlasOfRockPhysicsPlugin.ZonationWorksteps.Sc9_CopyWellLogUsingSpecifiedMarkers();
            PetrelSystem.WorkflowEditor.Add(sc9_copywelllogusingspecifiedmarkersInstance);
            m_sc9_copywelllogusingspecifiedmarkersInstance = new Slb.Ocean.Petrel.Workflow.WorkstepProcessWrapper(sc9_copywelllogusingspecifiedmarkersInstance);
            PetrelSystem.ProcessDiagram.Add(m_sc9_copywelllogusingspecifiedmarkersInstance, "Plug-ins");
            // Register AtlasOfRockPhysicsPlugin.Sc8_CopyWellLogInASpecifiedZone
            AtlasOfRockPhysicsPlugin.Sc8_CopyWellLogInASpecifiedZone sc8_copywellloginaspecifiedzoneInstance = new AtlasOfRockPhysicsPlugin.Sc8_CopyWellLogInASpecifiedZone();
            PetrelSystem.WorkflowEditor.Add(sc8_copywellloginaspecifiedzoneInstance);
            m_sc8_copywellloginaspecifiedzoneInstance = new Slb.Ocean.Petrel.Workflow.WorkstepProcessWrapper(sc8_copywellloginaspecifiedzoneInstance);
            PetrelSystem.ProcessDiagram.Add(m_sc8_copywellloginaspecifiedzoneInstance, "Plug-ins");
        ...
        {
            PetrelSystem.ProcessDiagram.Remove(m_sc9_copywelllogusingspecifiedmarkersInstance);
            PetrelSystem.ProcessDiagram.Remove(m_sc8_copywellloginaspecifiedzoneInstance);
